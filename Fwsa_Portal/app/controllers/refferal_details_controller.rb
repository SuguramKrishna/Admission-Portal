class RefferalDetailsController < ApplicationController
  ...
  def refferal_params
      params.require(:refferal_details).permit(:approach,:refferal_person_details,:refferal_person_name,:refferal_person_number,:refferal_person_relationship,:additional_information)
  end
end
