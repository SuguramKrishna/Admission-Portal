...
class EducationalDetailsController < ApplicationController
  def education
    redirect_to '/family_details/family' if educational_user == true
  end
